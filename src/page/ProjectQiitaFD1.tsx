...
const ProjectQiitaFD1 = () => {
  ...
  return (
    <Box>
      ...
      <Box>
        <Typography variant="subtitle1" fontSize="18px" margin='20px' color="black" fontFamily="sans-serif">
          Hello, I am the representative of ANTI SOCIETY. This time, I wowed the audience with my presentation 
          and the fact that I came from California, but when I started working on the project, I was a bit of a 
          toppin' pooh-pooh. First of all, we decided to make it in Flutter, and it took about 12 hours to set up 
          the environment ((I developed an allergy to Flutter)). Then I had to finish it in about 4 hours, so it may 
          have turned out poorly, but as an idea, and for a student with so little development experience... 
          I'm not sure if it was a good idea or not... 🙇 ...

          So thank you for looking at Qiita. I hope you will also check out the Github page as well.
        </Typography>
        <Box marginBottom={5} sx={{ background: `url('${projectQiitaFD1}')`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', height: '500px' }} />
      </Box>

      <Box>
        <Typography variant="h2" fontSize="30px" fontWeight="Bold" margin='5px' color="black" fontFamily="sans-serif">
          Raising Issues
        </Typography>
      ...
      <Box>
        ...
        <CodeSegment language="python" showLineNumbers={true} startingLineNumber={1}>
          {pythonCode}
        </CodeSegment>
      </Box>
